...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xl"> <a class="navbar-brand block" href="index.html"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo2.png"><!--<span class="h1 font-bold">Ring</span>--></a>
        <section class="m-b-lg">
            ...
            <?php echo CHtml::beginForm(Yii::app()->createUrl('site/forgot'), 'post'); ?>
            <div class="form-group">
                <?php echo CHtml::emailField('email', '', array('class' => 'form-control rounded input-lg text-center no-border', 'placeholder' => 'Email')); ?>
            </div>
