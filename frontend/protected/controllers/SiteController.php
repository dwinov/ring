...
class SiteController extends Controller
{
    ...
    public function accessRules()
    {
        return array(
            ...
            array(
                'allow',
                'actions' => array('login', 'signup', 'forgot', 'resetpassword', 'changepassword', 'error', 'register'),
                'users' => array('*'),
            ),
            array(
                'deny',
    ...
    {
        if(isset($_POST['Member']) && isset($_POST['User']) && $_POST['tnc'] == 'on')
        {
            $user = new User();
            $member = new Member();
    ...
    public function actionForgot()
    {
        ...
        if(isset($_POST['email']))
        {
            ...
            if($model)
            {
                ...
                if(Helper::sendEmail('forgotpassword', $model, 'Forgot Password Ring'))
                {
                    $this->redirect(Yii::app()->homeUrl);
                }else{
                    $this->redirect(Yii::app()->homeUrl);
