<div class="heading-buttons">
    <h2 class="glyphicons group"><i></i> Event Organizer</h2>
            ...
            aoColumns: [
                ...
                },
                {
                    ...
                    mRender: function(data, type, all) {
                        var btns = new Array();
                        btns.push("<a class='btn-action glyphicons calendar btn-info' href='<?php echo Yii::app()->createUrl('event/create'); ?>/id/" + all.eo_id + "/?role=2' title='Create Event'><i></i></a> ");
