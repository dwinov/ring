        ...
        <div class="tab-content" style="padding: 0;">
            <div class="tab-pane active" id="account-details">
                ...
                <div class="widget widget-2 primary widget-body-white">
                    ...
                    <?php echo (isset($model)) ? Chtml::hiddenField('Interest[int_id]', $model->int_id) : null; ?>
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php $name = (isset($model)) ? $model->int_name : ""; ?>
                                        <?php echo CHtml::textField('Interest[int_name]', $name, array('class' => 'span12')); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
