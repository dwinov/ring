...
?>
    <div class="heading-buttons">
        <h2 class="glyphicons check"><i></i>Manage Event</h2>
    ...
    <div class="widget widget-2">
        <div class="widget-head">
            <h4 class="heading glyphicons calendar"><i></i>Lists Events</h4>
        </div>
    ...
    <!-- dialog box -->
    <div id="dialog" title="Delete Event" style="display: none;">
        <p>Are you sure?</p>
    </div>
