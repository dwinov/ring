...
<head>
    ...
    <!-- Theme -->
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/club/style.min.css?1359188708" />
                    ...
                    <div class="rrow scroll-y" id="mainYScroller">
                        <div class="inner topRight"><div class="positionWrapper loginWrapper hide">
                                ...
                                <div class="box-1 loginbox">
                                    <div class="inner">
                                        <?php echo CHtml::beginForm(Yii::app()->createUrl('site/login'), 'post', array('id' => 'login-form', 'class' => 'fts')); ?>
                                        <fieldset>
                                ...
                                <div class="btn-register">
                                    <a href="#" style="width: 72%;" class="btn btn-icon btn-success glyphicons edit"><i></i>Forgot Password</a>
                                </div>
                            </div>
                            <div>
                                <div class="positionWrapper registerWrapper hide">
                                    ...
                                    <div class="box-1 registerbox">
                                        <div class="inner">
                                            <form action="<?=Yii::app()->createUrl('site/submitForgotPassword')?>" method="post" class="fts">
                                                <input type="email" name="user_email" placeholder="Username" />
                                                <?php echo CHtml::submitButton('Submit',array('class'=>'btn btn-icon btn-block glyphicons right edit btn-success')); ?>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="btn-login">
